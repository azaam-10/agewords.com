            ...
            <div className="p-6 flex flex-col items-center text-center space-y-4" dir="rtl">
              ...
              {modalStep === 1 && (
                <>
                  ...
                  <h3 className="text-lg font-bold text-gray-800">أهلاً بك A5VSVP5CH000</h3>
                ...
                <>
                  <div className="bg-red-50 p-4 rounded-xl border border-red-100 text-right w-full">
                    ...
                    <p className="text-[13px] text-red-700 leading-relaxed">
                      أهلاً بك A5VSVP5CH000، بقي أمر إيداع مبلغ <span className="font-bold underline">177.2 USDT BEP-20</span> لفتح قناة السحب.
                    </p>
